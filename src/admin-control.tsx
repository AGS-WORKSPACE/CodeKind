...
function AdminSoon({section}:{section:string}){
 return <div className="admin-page">
  ...
  <section className="admin-panel"><p className="org-empty">What is live today: tutor applications, session payments, appeals, wallet credits, money settings, session evidence, reference lists and the error log.</p></section>
 </div>;
}
